...
class MainTestCase(unittest.TestCase):
    def test_parse_args_c_encrypt(self):
        # Caso de prueba con linea de comandos de opcion c correcta
    ...
    def test_parse_args_d_decrypt(self):
        # Caso de prueba con linea de comandos de opcion d correcta
    ...
    def test_parse_args_invalid_option(self):
        # Caso de prueba con linea de comandos incorrecta
    ...
    def test_derive_key(self):
        ...
        expected_key = b'l3RMFUtpa9Tp-auqDRrl54wKhYUMz6fNX3YiVrWcqtk=' 
    ...
    def test_derive_key_different_password(self):
        ...
        expected_key = b'04Ygta5ZSToJ-E8cK74WCkpFr-vwTJUiuahZ0ZOGyKs='
        actual_key = derive_key(password)
        self.assertEqual(actual_key, expected_key)
